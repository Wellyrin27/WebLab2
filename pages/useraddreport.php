...
?>
    <div class="container">
        <a href="userpage.php">Ваши доклады</a>
        ...
        <form action="../php/addreport.php" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <textarea class="form-control" name="info_speaker" placeholder="Расскажите немного о себе" rows="3"><? if (isset($_COOKIE['info_speaker'])) echo $_COOKIE['info_speaker']?></textarea>
            </div>
            <div class="row">
            ...
            <button class="btn btn-primary mb-3">Разместить на сайте</button>
            <?php
